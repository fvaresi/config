...
** Version Control
   ...
   #+begin_src emacs-lisp
     (setq magit-repository-directories '(("~/projects/baxenergy/farsight" . 0)
     				     ("~/projects/baxenergy/farsight-local-ops" . 0)))
   #+end_src
     	 ...
     	 (when matches
     	   (let ((tickets (if (> (length matches) 1)
     	     ...
     	     (dolist (ticket tickets)
     	       (browse-url (concat "https://baxenergy.atlassian.net/browse/" ticket)))))
     	 ))
