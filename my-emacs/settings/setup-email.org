...
** Identity
   #+begin_src emacs-lisp
     (setq user-mail-address "fernando.varesi@baxenergy.com"
	   user-full-name "Fernando Varesi")
   #+end_src
...
** Gnus-alias
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq gnus-alias-identity-alist
	   '(("mind"
	      nil
	      "Fernando Varesi <fvaresi@mindresearch.org>"
	      "Mind Research"
	      nil
	      nil
	      nil)))
     (setq gnus-alias-default-identity "mind")
