...

=T0Yt
-----END PGP MESSAGE-----
...
** Org Notify
   #+BEGIN_SRC emacs-lisp
     ...
     (org-notify-add 'short-notice
                     '(:time "-1s" :duration 600 :actions (-message -ding))
                     '(:time "10m" :period "5m" :duration 15 :actions -notify))
...
** Special functions						   :noexport:
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (defun fvaresi/sprint-end-values ()
       (let* ((current (current-time))
              (current-dow (nth 6 (decode-time current)))
              (day-shift (mod (- 1 current-dow) 7))
              (next-monday (time-add current (days-to-time day-shift)))
              (following-monday (time-add current (days-to-time (+ 7 day-shift))))
              (date-format "%Y-%m-%d"))

         (list (format-time-string date-format next-monday)
               (format-time-string date-format following-monday))))
   #+END_SRC
